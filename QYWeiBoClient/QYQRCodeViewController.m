...
@interface QYQRCodeViewController ()
   ...
   [self dismissViewControllerAnimated:YES completion:^
    {
        [timer invalidate];
        NSLog(@"%@",stringValue);
        UIAlertView *alertView =[ [UIAlertView alloc] initWithTitle:@"content" message:stringValue delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
        [alertView show];
    }];
}
